...
<div class="col s12 m4">
  <div class="card">  
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator materialboxed responsive-img z-depth-1" src="../images/showcase/euvi.png">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Euvi App<i class="material-icons right">info_outline</i></span>
      <p class="center-align">        
        <a class=" modal-trigger waves-effect waves-light btn blue" href="#euvi"><i class="material-icons right">open_in_new</i>Ver Projeto</a>
      </p>
    </div>
...
<!-- MODAL CONTENT JOB -->
<div id="euvi" class="modal modal-edit bottom-sheet ">
  <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat right">
    <h5 class="close">Close X</h5>
  </a>
  <!-- BANNER PROJECT -->
  <div class="section no-pad-bot" id="euvi-banner">
    <div class="container">
      <h1 class="header center-on-small-only">Euvi app</h1>
