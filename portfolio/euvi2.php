...
<div class="col s12 m4">
  <div class="card">  
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator materialboxed responsive-img z-depth-1" src="../images/showcase/closeheat.png">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Job 1<i class="material-icons right">info</i></span>
      <p class="center-align">        
        <a class=" modal-trigger waves-effect waves-light btn blue" href="#job1"><i class="material-icons right">open_in_new</i>Ver Projeto</a>
      </p>
    </div>
...
<!-- MODAL CONTENT JOB -->
<div id="job1" class="modal modal-edit bottom-sheet ">
